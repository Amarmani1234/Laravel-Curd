...
@endif
      ...
      <div class="container container-tight py-4">
        <div class="text-center mb-4">
          <a href="." class="navbar-brand navbar-brand-autodark">
            <img src="public/logo.svg" width="110" height="32" alt="Tabler" class="navbar-brand-image">
          </a>
        </div>
    ...
    @endif
        ...
        <form class="card card-md" method="post" action="{{route('signup')}}">
        @csrf
          <div class="card-body">
        ...
        <div class="text-center text-secondary mt-3">
          Already have account? <a href="admin" tabindex="-1">Sign in</a>
        </div>
      </div>
    </div>
  </body>
